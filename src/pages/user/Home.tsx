...
const Home: React.FC = () => {
  ...
  const allPosts = posts.length > 0 ? [...MOCK_POSTS, ...posts] : MOCK_POSTS;
    ...
    <div className="homepage-container">
      ...
      <section className="posts-section-card">
        <div className="posts-section-inner">
          ...
          <Tabs activeKey={selectedView} onChange={setSelectedView}>
